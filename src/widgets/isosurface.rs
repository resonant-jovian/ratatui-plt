...
impl Isosurface {
    ...
    fn march_cubes(&self, nx: usize, ny: usize, nz: usize) -> Vec<[(f64, f64, f64); 3]> {
        ...
        for iz in 0..nz - 1 {
            for iy in 0..ny - 1 {
                for ix in 0..nx - 1 {
                    ...
                    let mut edge_verts: [Option<(f64, f64, f64)>; 12] = [None; 12];
...
impl crate::plotters_render::PlottersRenderable for Isosurface {
    fn render_plotters(
        &self,
